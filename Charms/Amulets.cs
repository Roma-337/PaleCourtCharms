...
namespace PaleCourtCharms
{
    internal partial class Amulets : MonoBehaviour
    {
        ...
        public void Awake()
        {
        PaleCourtCharms.Instance.Log("Amulets Awake called");
        ...
        public void On_HeroController_Start(On.HeroController.orig_Start orig, HeroController self)
        {
            ...
            Log("Got Charm 41: " + PaleCourtCharms.Settings.gotCharms[0]);
            Log("Got Charm 42: " + PaleCourtCharms.Settings.gotCharms[1]);
            Log("Got Charm 43: " + PaleCourtCharms.Settings.gotCharms[2]);
            Log("Got Charm 44: " + PaleCourtCharms.Settings.gotCharms[3]);
            Log("New Charm 41: " + PaleCourtCharms.Settings.newCharms[0]);
            Log("New Charm 42: " + PaleCourtCharms.Settings.newCharms[1]);
            Log("New Charm 43: " + PaleCourtCharms.Settings.newCharms[2]);
            Log("New Charm 44: " + PaleCourtCharms.Settings.newCharms[3]);
            Log("Equipped Charm 41: " + PaleCourtCharms.Settings.equippedCharms[0]);
            Log("Equipped Charm 42: " + PaleCourtCharms.Settings.equippedCharms[1]);
            Log("Equipped Charm 43: " + PaleCourtCharms.Settings.equippedCharms[2]);
            Log("Equipped Charm 44: " + PaleCourtCharms.Settings.equippedCharms[3]);
            Log("Upgraded Charm 10: " + PaleCourtCharms.Settings.upgradedCharm_10);
