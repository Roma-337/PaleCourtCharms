  ...
  {public override void GiveImmediate(GiveInfo info)
{
    ...
    PaleCourtCharms.Instance.Log($"[PC_CharmItem] Granted charm {charmNum} ({name}).");
}
    ...
    public PC_CharmItem(int idx)
{
    ...
    UIDef = new MsgUIDef
    {
        ...
        shopDesc = new LanguageString("UI", $"CHARM_DESC_{charmNum}"),
        sprite = new ICShiny.ItemChangerSprite(key, PaleCourtCharms.Charms[idx].Icon)
    };
